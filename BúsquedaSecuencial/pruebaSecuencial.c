...
{int i,numReg;
 ...
 char dni[10];
  ...
  //Fin de B�squeda
	...
	strcpy(reg.dni, "11111111");
	strcpy(reg.nombre, "PEPE");
	strcpy(reg.ape1, "PEREZ");
	strcpy(reg.ape2, "LOPEZ");
	strcpy(reg.provincia, "ZAMORA");
	
	i=insertaReg("alumnos.dat", &reg); 
	

	i=modificarReg("alumnos.dat", reg.dni, "TOKYO");
